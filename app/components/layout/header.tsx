...
import { ProjectXIcon } from "@/components/icons/projectx"
        ...
        <div className="flex flex-1 items-center justify-between">
          <div className="-ml-0.5 flex flex-1 items-center gap-2 lg:-ml-2.5">
            <div className="flex flex-1 items-center gap-2">
              <Link
                href="/"
                className="pointer-events-auto inline-flex items-center gap-1.5 text-xl font-medium tracking-tight"
              >
                <ProjectXIcon className="size-5 text-foreground" />
                {APP_NAME}
              </Link>
